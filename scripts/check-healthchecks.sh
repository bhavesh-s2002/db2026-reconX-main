...
# TICKET-ADV152 — Healthcheck audit script
# ============================================================================
set -euo pipefail
...
[[ "$s" == "healthy" ]] || { echo "backend not healthy"; docker exec reconx-backend wget -qO- http://localhost:8081/api/actuator/health; exit 1; }
